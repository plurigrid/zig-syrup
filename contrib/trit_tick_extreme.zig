...
test "all 139 rates divide exactly" {
    const rates = [_]u64{
        ...
        60,    64,    70,    72,     75,     80,     90,     96,     100,    120,     125,     128,      130,      140,     144,      150,      160,   165,
        185,   200,   220,   240,    250,    256,    300,    360,    400,    480,     500,     508,      512,      540,     600,      800,      1000,  1017,
        1024,  1200,  1600,  2000,   2034,   2048,   2400,   2500,   3000,   3200,    4000,    4096,     4800,     5000,    6400,     8000,     8192,  9600,
        10000, 11025, 12000, 15000,  16000,  16384,  19200,  20000,  22050,  24000,   25000,   30000,    32000,    32768,   38400,    40000,    44100, 48000,
        50000, 88200, 96000, 100000, 176400, 192000, 250000, 352800, 384000, 500000,  1000000, 2000000,  2822400,  5644800, 11289600, 22579200,
        // epoch 3 new (34)
        7,     9,
        14,    21,    27,    28,     34,     49,     55,     65,     81,     86,      89,      114,      151,      233,     243,      377,      720,   729,
        1001,  2187,  6561,  19683,  59049,  65536,  86400,  131072, 400000, 1048576, 5000000, 10000000, 45158400,
    };
    for (rates) |rate| {
        if (TICKS_PER_SECOND % @as(u128, rate) != 0) {
