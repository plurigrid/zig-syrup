...
| **Utilities** | `demo.nu`, `workflows.nu`, `dashboard.nu`, `repl.nu`, `utils.nu`, `hooks.nu`, `themes.nu`, `aliases.nu`, `init.nu`, `worldprime.nu`, `test.nu` | Tools, demos, themes, setup |
...
```nu
# Workflows
worldprime workflow bci-focus-tracker    # Focus detection workflow
worldprime workflow ab-test-eeg          # 3-player A/B test with EEG
worldprime workflow meditation-monitor   # Meditation depth tracking
worldprime workflow sleep-recorder       # Overnight recording
worldprime workflow neurofeedback-game   # BCI-controlled game

# Dashboard
worldprime dashboard                     # Launch terminal dashboard
worldprime dashboard --theme ocean       # With theme

# REPL
worldprime repl                          # Interactive REPL
worldprime repl --theme matrix           # Themed REPL

# Utilities
worldprime doctor                        # System health check
worldprime update                        # Check for updates
worldprime demo                          # Interactive demo
worldprime demo --mode quick             # Quick demo
worldprime demo --mode full              # Full demonstration
...
dashboard # worldprime dashboard
repl   # worldprime repl
```
...
worldprime workflow meditation-monitor
...
worldprime workflow sleep-recorder
...
worldprime workflow neurofeedback-game
...
```nuon
{
    ...
    worlds: {
        ...
        persistence_dir: "~/.local/share/worldprime"
    }
...
# Debug mode
worldprime demo --verbose
```

## Integration with Zig Syrup

The worldprime system integrates with the Zig syrup backend:
