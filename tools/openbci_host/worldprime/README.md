...
Hypergraph-based BCI (Brain-Computer Interface) data processing system for worldprime. Implements a phased pipeline architecture with acquisition → preprocessing → analysis → output flow.
