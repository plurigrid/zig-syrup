...
export def log-protocol-access [
    ...
    let log_file = ($nu.home-path | path join ".config" "worldprime" "protocol_access.log")
...
export def update-access-cache [uri: string]: [ nothing -> nothing ] {
    let cache_file = ($nu.home-path | path join ".config" "worldprime" "access_cache.nuon")
...
export def "world-protocol alias" [
    ...
    let aliases_file = ($nu.home-path | path join ".config" "worldprime" "aliases.nuon")
